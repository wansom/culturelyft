      ...
      <div className="flex flex-col md:flex-row gap-10">
        <div className="welcome-card h-[300px] rounded-[16px] bg-[#D7F5E8] basis-2/3 w-full p-10 flex">
          <div>
            ...
            <div>
            <button
                  class="block w-1/2 px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#01382E] border border-transparent rounded-lg active:bg-[#01382E] hover:bg-[#13A8BD] focus:outline-none focus:shadow-outline-purple"
                >
          ...
          >
            ...
            <image href="/character_3.png" height="300" x="312" y="30"></image>
          </svg>
        </div>
