    ...
    <div className="flex  flex-wrap lg:flex-nowrap items-center justify-evenly gap-10 my-6">
      <div className="space-y-2 md:basis-2/3">
        ...
        <p>
          ...
          identified feedback, fostering an environment where every team member
          feels heard. Empower employees to give feedback to their peers, share
          insights on workplace issues, and track feedback responses to ensure a
          positive work environment and peak team performance.
        </p>
