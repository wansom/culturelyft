...
<button type="button" disabled class="flex items-center justify-center text-white bg-[#01382E] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800" onClick={()=>{setIsOpen(true)}}>
    ...
    <div className="flex  flex-wrap lg:flex-nowrap items-center justify-evenly gap-10 my-6">
      <div className="space-y-2 md:basis-2/3">
        <h1 className="text-2xl font-bold">Asssistant Assessment Center</h1>
        <p>
          You don't have any open assessments yet. Assessments are available after the first week of training and run all throught your sales assistant career
        </p>
