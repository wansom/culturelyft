...
const Chatbox = () => {
  ...
  return (
    <main class="dash-view my-4">
      <div class="inbox-content flex items-start justify-between">
        <div class="inbox-messages  basis-1/4">
            ...
            <div id="msg-inbox" class={`msgtabcontent ${isOpen ? 'hidden' : 'block'}`}>
              <div class="msg-person">
                ...
                <div class="msg-p-status">
                  <button class="txt-status">Done 🎉</button>
                </div>
              </div>
              <div class="msg-person">
                <div class="p-image">
              ...
              <div class="msg-person">
                ...
                <div class="m-p-txt">
                  <h4>John Kawaida</h4>
                  <div class="last-msg-time">
                    <span class="unread-reply">How would he react to demotion?.</span>
                    <span>Fri</span>
                  </div>
                </div>
                <div class="msg-p-status">
        ...
        <div class="msg-box basis-1/4">
          <div class="msg-bx-top">
            <div class="user-mgs-bx">
              ...
              <img src="/logo.png" alt="User Messaging info" />
              <div class="userinfo-msg-bx">
                <h4>Amelia Kwaida</h4>

              </div>
            </div>
            <button class="internal internal-btn">HR</button>
          </div>
            ...
            <div class="messages">
              <div class="sender boxed-messages">
                <div class="sender-image">
                  <img src="/Profile.png" alt="Message sender image" />
                </div>
                <div class="sender-message">
                  <div class="sender-message-txt">
                    <p>Hello,Which profile would you like to create today!</p>
                  </div>
              ...
              <div class="reciever boxed-messages">
                <div class="reciever-message">
                  ...
                  <div class="reciever-message-txt">
                    <p>Hello,I want to know how Mambo would react if she was demoted from her current postion</p>
                  </div>
              ...
              <div class="sender boxed-messages">
                ...
                <div class="sender-message">
                  <div class="sender-message-txt">
                    <p>Based on Mambo's profile, she seems to have a lot of experience having worked in the department for 2 years. Her relationship with her colleagues is great and she only has 1 disciplinary case.
                      Her sanguin personality serves her well, she will easily adopt in whichever role she is put and make new friends there. However, make sure to have a conversation beforehand to make her understand your decision
                    </p>
                  </div>
                  <div class="sender-message-time">
                    <span>7:14 AM</span>
