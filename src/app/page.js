          ...
          <div class="bn-text mt-10">
            <div class="bn-txt-holder">
              ...
              <Link href="https://calendly.com/culturelyft-info/30min"
                class=" block  px-4 py-2 text-md uppercase font-medium leading-5 text-center text-white transition-colors duration-150 bg-orange-500 border border-transparent rounded-lg active:bg-[#01382E] hover:bg-[#13A8BD] focus:outline-none focus:shadow-outline-purple"
              >
               TALK TO OUR TEAM
              </Link>
              <Link href="/register"
                class=" flex imtes-center justify-center gap-2  px-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 border-orange-500  border-solid border-2 rounded-lg active:bg-[#e58e04] hover:bg-[#e58e04] hover:text-white focus:outline-none focus:shadow-outline-purple"
              >
        ...
        <div class="about-container  mx-auto flex flex-col-reverse md:flex-row  items-start justify-between gap-20">
          ...
          <div class="md:basis-1/2">
            ...
            <div>
              ...
              <Link href='https://calendly.com/culturelyft-info/30min' className='mt-10 flex items-center text-[#e58e04] flex-nowrap hover:border-solid hover:border-2 hover:border-[#e58e04] w-fit px-4 gap-3'>TALK TO OUR TEAM <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
