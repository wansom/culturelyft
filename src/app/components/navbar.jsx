        ...
        <div class="flex  items-center justify-between mx-auto px-5">
          ...
          <div className={isOpen ? "active links" : "hide links"} id="links">
            ...
            <button onClick={()=>{router.push('/register')}}
                class=" flex imtes-center justify-center gap-2  px-4 py-2 text-sm font-medium leading-5 text-center text-[#081a43] transition-colors duration-150 border-[#e58e04]  border-solid border-2 rounded-lg active:bg-[#e58e04] hover:bg-[#e58e04] hover:text-white focus:outline-none focus:shadow-outline-purple"
              >
               REGISTER NOW<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
