...
const UsersTable = ({ user, employees }) => {
  ...
  <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{i.name}</th>
  <td class="px-4 py-3">{i.email}</td>
  <td class="px-4 py-3">{i.role}</td>
  <td class="px-4 py-3">{i.date}</td>
  <td class="px-4 py-3">{i.department}</td>
