...
const DashboardSidebar = ({ toggleIsOpen }) => {
    ...
    <nav class="w-full p-4 bg-[#01382E] sticky top-0 h-full">
      <div class="ins-lg -mt-6">
        <div class="dash-lg ">
          <Link href="/" class="nav-logo">
            <Image src="/logo-white.png" alt="logo" width={150} height={80} />
          </Link>
        </div>
      ...
      <div class="dash-links -mt-8">
        <div class="link">
          <Link
            href="/dashboard"
            class={` ${pathname === "/dashboard" ? "active" : ""}`}
          ...
          >
            <div class="link-icon">
              ...
              >
                ...
                />
                <path
                  d="M4.15576 5.98242L9.55145 10.9709L14.9471 5.98242"
                  stroke="#ADC9CD"
                  stroke-miterlimit="10"
                />
              </svg>
        ...
        <div class="link">
          <Link
            ...
            class={`${pathname === "/dashboard/engagement" ? "active" : ""}`}
            onClick={toggleIsOpen}
          >
            <div class="link-icon">
              <svg
        ...
        <div className="link">
          <Link
            ...
            class={` ${pathname === "/dashboard/programs" ? "active" : ""}`}
            onClick={toggleIsOpen}
          >
            <div class="link-icon">
              <svg
              ...
              >
                ...
                <path
                  ...
                  fill="#ADC9CD"
                  mask="url(#path-2-outside-1_1_295)"
                />
                <path
                ...
                <path
                  ...
                  fill="#ADC9CD"
                  mask="url(#path-5-outside-2_1_295)"
                />
              </svg>
            </div>
