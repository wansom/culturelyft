        ...
        <div class="banner-container basis-2/2 md:basis=1/3">
          <div class="bn-text mt-10">
            <div class="bn-txt-holder">
              ...
              <p className="mx-5 md:mx-28 my-5 text-black">
                Culturelyft provides a safe and anonymous way for employees to
                share their feedback with you, so you can make informed
                decisions about your company culture.
              </p>
              <Link
                href="/myissue"
                class=" flex items-center justify-center w-[50%] md:ml-28 px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#01382E] border border-transparent rounded-lg active:bg-[#01382E] hover:bg-[#13A8BD] focus:outline-none focus:shadow-outline-purple ml-10"
              >
                Track Submitted Issue
                <svg
            ...
            <Drawer isOpen={isOpen} setIsOpen={setIsOpen}>
              {!trackindId && (
                <div className="mx-auto my-10 p-5 bg-gray-200 w-[90%] rounded-lg">
                  <h2 className="font-semibold text-10">
                    {" "}
                    Dear {formData.name},
                  </h2>
                  <p className="text-gray-600 text-6">
                    Culturelyft is a platform dedicated to empowering employees
                    to voice their feedback in a safe and anonymous way. We
                    believe that honest insights from your team can lead to
                    significant improvements in company culture, career
                    development opportunities, and overall employee
                    satisfaction. Today, we are delivering an anonymous message
                    from one of your employees. Please read carefully and
                    consider their perspective:
                  </p>{" "}
                  <br />
                  <p className="font-bold text-black text-6">
                    {formData.message}
                  </p>
                  <br></br>
                  <p className="text-gray-600 text-6">
                    Click here to log in to your Culturelyft portal to reply and
                    view other feeback from your team
                  </p>
                  <br />
              ...
              {trackindId && (
                <div className="mx-auto my-10 p-5 bg-gray-200 w-[90%] rounded-lg">
                  <h2 className="font-semibold text-10">
                    Here is your issue ID. Copy and use it to check if your
                    feedback has been responded to
                  </h2>
                  <div className="">
                    <CopyToClipboard text={trackindId} onCopy={handleCopy}>
                      <div className="border-2 border-solid border-black py-2 w-full rounded-lg my-2 flex items-center justify-between px-3 text-[#13A8BD] cursor-pointer">
                        {trackindId}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form class="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                    <div>
                      ...
                      >
                        what would you like to give feeback on?
                      </label>
                      <textarea
                        ...
                        placeholder="provide honest feedback"
                        required=""
                      ></textarea>
                    </div>
                    <div>
                      <label
                        ...
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                      >
                        Who should receive this feedback?(Email)
                      </label>
                      <input
                    ...
                    <div>
                      <label
                        ...
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                      >
                        Who should receive this feedback?(Name)
                      </label>
                      <input
                        value={formData.name}
                        onChange={handleChange}
